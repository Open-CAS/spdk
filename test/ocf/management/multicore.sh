...
$rpc_py bdev_ocf_create C1 Cache Core0 --create --force
$rpc_py bdev_ocf_create C2 Cache Core1 --create --force
...
$rpc_py bdev_ocf_create C1 Cache Malloc --create --force
$rpc_py bdev_ocf_create C2 Cache Core --create --force
...
$rpc_py bdev_ocf_create C1 Malloc NonExisting --create --force
$rpc_py bdev_ocf_create C2 Malloc NonExisting --create --force
$rpc_py bdev_ocf_create C3 Malloc Core --create --force
