...
if __name__ == "__main__":
    ...
    p.add_argument('--cpu-mask', '-n', help='CPUs to which background tasks (only cleaner at the moment) will be pinned to', default='0')
    ...
    def bdev_ocf_set_cleaning_alru(args):
        rpc.bdev.bdev_ocf_set_cleaning_alru(args.client,
                                            name=args.name,
    ...
    def bdev_ocf_set_cleaning_acp(args):
        rpc.bdev.bdev_ocf_set_cleaning_acp(args.client,
                                           name=args.name,
                                           wake_up=args.wake_up,
                                           flush_max_buffers=args.flush_max_buffers)
    ...
    def bdev_ocf_set_cleaning_nop(args):
        rpc.bdev.bdev_ocf_set_cleaning_nop(args.client, name=args.name)
